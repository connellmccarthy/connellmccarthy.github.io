(function e(t, n) {
  ...
  else if (typeof exports === "object") exports["SwupGtagPlugin"] = n();
  else t["SwupGtagPlugin"] = n();
})(window, function () {
  return (function (e) {
    var t = {};
    function n(r) {
            ...
            value: function e() {
              ...
              this.swup.on("contentReplaced", function (e) {
                if (
                  ...
                  t.options.gaMeasurementId != undefined
                ) {
                  var n = document.title;
                  var r = window.location.pathname + window.location.search;
                  window.gtag("config", "" + t.options.gaMeasurementId, {
                    page_title: n,
                    page_path: r,
                  });
                  t.swup.log("Gtag pageview (url '" + r + "').");
                } else {
